...
class Raftnode:
    ...
    def receive_external_handler(self, message):
        print("Received external message " + str(message))
        mtype = message['type']
    ...
    def receive_internal_handler(self, message):
        if message['type'] != 'internal':
            print("ERROR: receiver internal handler somehow got a non-internal message")
